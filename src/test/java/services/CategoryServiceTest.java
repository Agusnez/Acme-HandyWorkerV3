...
public class CategoryServiceTest extends AbstractTest {
	...
	public void testSaveDuplicate(){
		...
		Collection<Category> categories2 = this.categoryService.findAll();
	...
	public void testDeleteCategoryUnlogged(){ /*Con este test vamos a comprobar la seguridad de autenticación*/
		...
		Category category2 = this.categoryService.findOne(2594); /*Category 2 en el populate*/
		...
		super.authenticate("admin");
		Category categoryFind = this.categoryService.findOne(2594);
...
//		super.authenticate("admin");
//		
//		Category category2 = this.categoryService.findOne(2594);/*categoria padre*/
//		Category category4 = this.categoryService.findOne(2596); /*categoría hija*/
//		FixUpTask fixUpTask = this.fixUpTaskService.findOne(2600); /*FixUp que tiene como categoría la categor2*/
//		
//		this.categoryService.delete(category2);
//		
